...
var i_14875 = (0);
while(true){
if((i_14875 < arr.length)){
(arr[i_14875] = null);

var G__14878 = (i_14875 + (1));
i_14875 = G__14878;
continue;
} else {
}
...
var i_14960 = (self__.level + (1));
while(true){
if((i_14960 <= (new_level + (1)))){
(update[i_14960] = self__.header);

var G__14963 = (i_14960 + (1));
i_14960 = G__14963;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14965 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14965[i]));
} else {
x__$2.forward.push((((i < links_14965.length))?(links_14965[i]):null));
}

if((i < links_14965.length)){
(links_14965[i] = x__$2);
} else {
links_14965.push(x__$2);
}
...
var i_14978 = (0);
while(true){
if((i_14978 <= self__.level)){
var links_14980 = (update[i_14978]).forward;
if((x__$1 === (((i_14978 < links_14980.length))?(links_14980[i_14978]):null))){
(links_14980[i_14978] = (x__$1.forward[i_14978]));

var G__14981 = (i_14978 + (1));
i_14978 = G__14981;
continue;
} else {
var G__14982 = (i_14978 + (1));
i_14978 = G__14982;
continue;
}
} else {
...
var G__14992 = nx;
var G__14993 = (level__$1 - (1));
x = G__14992;
level__$1 = G__14993;
continue;
} else {
var G__14994 = x;
var G__14995 = (level__$1 - (1));
x = G__14994;
level__$1 = G__14995;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__15009 = nx;
var G__15010 = (level__$1 - (1));
x = G__15009;
level__$1 = G__15010;
continue;
} else {
var G__15011 = x;
var G__15012 = (level__$1 - (1));
x = G__15011;
level__$1 = G__15012;
continue;
}
