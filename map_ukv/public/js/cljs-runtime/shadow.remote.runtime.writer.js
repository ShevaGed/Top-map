...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((""+"The limit of "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(self__.limit)+" bytes was reached while printing."),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword("shadow.remote.runtime.writer","limit-reached","shadow.remote.runtime.writer/limit-reached",1304350996),new cljs.core.Keyword(null,"limit","limit",-1355822363),self__.limit], null));
} else {
return null;
}
}));
...
(shadow.remote.runtime.writer.LimitWriter.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"shadow.remote.runtime.writer/LimitWriter");
}));
