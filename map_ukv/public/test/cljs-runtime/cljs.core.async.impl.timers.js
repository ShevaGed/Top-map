...
var i_14079 = (self__.level + (1));
while(true){
if((i_14079 <= (new_level + (1)))){
(update[i_14079] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14083 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14083[i]));
} else {
x__$2.forward.push((((i < links_14083.length))?(links_14083[i]):null));
}

if((i < links_14083.length)){
(links_14083[i] = x__$2);
} else {
links_14083.push(x__$2);
}
...
var i_14088 = (0);
while(true){
if((i_14088 <= self__.level)){
var links_14089 = (update[i_14088]).forward;
if((x__$1 === (((i_14088 < links_14089.length))?(links_14089[i_14088]):null))){
(links_14089[i_14088] = (x__$1.forward[i_14088]));

var G__14090 = (i_14088 + (1));
i_14088 = G__14090;
continue;
} else {
var G__14091 = (i_14088 + (1));
i_14088 = G__14091;
continue;
}
} else {
...
var G__14106 = nx;
var G__14107 = (level__$1 - (1));
x = G__14106;
level__$1 = G__14107;
continue;
} else {
var G__14108 = x;
var G__14109 = (level__$1 - (1));
x = G__14108;
level__$1 = G__14109;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14116 = nx;
var G__14117 = (level__$1 - (1));
x = G__14116;
level__$1 = G__14117;
continue;
} else {
var G__14118 = x;
var G__14119 = (level__$1 - (1));
x = G__14118;
level__$1 = G__14119;
continue;
}
